    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_telefone', models.CharField(choices=[('FIX', 'Fixo'), ('CEL', 'Celular'), ('FAX', 'Fax'), ('OUT', 'Outro')], max_length=8)),
                ('telefone', models.CharField(max_length=32)),
                ('pessoa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='person.person')),
            ],
        ),
        migrations.CreateModel(
            name='Email',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_endereco', models.CharField(choices=[('UNI', 'Único'), ('RES', 'Residencial'), ('COM', 'Comercial'), ('COB', 'Cobrança'), ('ENT', 'Entrega'), ('OUT', 'Outro')], max_length=3)),
                ('logradouro', models.CharField(max_length=255)),
                ('numero', models.CharField(max_length=16)),
                ('bairro', models.CharField(max_length=64)),
                ('pais', models.CharField(default='Brasil', max_length=32)),
